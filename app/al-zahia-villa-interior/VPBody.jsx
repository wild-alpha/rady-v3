  ...
  return (
    <section className="bg-black text-white px-6 sm:px-10 md:px-16 lg:px-28 xl:px-40 py-10 sm:py-20 font-sans">
      ...
      <p className="text-xs text-[#f0c95a] uppercase tracking-widest mb-4 font-conthrax">
        HOME &gt; PROJECTS &gt; AL ZAHIA VILLA INTERIOR
      </p>
      ...
      <div className="relative pl-4 sm:pl-6 mb-20">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-sm sm:text-2xl md:text-3xl font-conthrax tracking-widest text-white mt-1">
            AL ZAHIA VILLA INTERIOR DESIGN
          </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              <p>
                At WE DO Interior Design & Fitout, we present our Al Zahia Villa Interior project, designed to reflect modern luxury living in one of Sharjah’s most prestigious residential communities.
              </p>
              <p>
                Our design approach focused on creating elegant, functional, and comfortable spaces that enhance family living while maintaining a refined aesthetic throughout the villa.
              </p>
              <p>
                Through our complete villa interior design and fit-out solutions, we transformed this residence into a sophisticated home that blends contemporary style with timeless elegance.
              </p>
            </div>
          </div>
      ...
      <h2 className="text-white mt-10 mb-10 text-sm sm:text-xl tracking-widest font-conthrax text-center">
        AL ZAHIA VILLA INTERIOR GALLERY
      </h2>
