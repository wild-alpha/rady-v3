  ...
  return (
    <section className="bg-black text-white px-6 sm:px-10 md:px-16 lg:px-28 xl:px-40 py-10 sm:py-20 font-sans">
      ...
      <p className="text-xs text-[#f0c95a] uppercase tracking-widest mb-4 font-conthrax">
        HOME &gt; Dubai &gt;Villa Mirdif – Interior Design in Dubai
      </p>
      ...
      <div className="relative pl-4 sm:pl-6 mb-20">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-sm sm:text-2xl md:text-3xl font-conthrax tracking-widest text-white mt-1">
           VILLA MIRDIF – INTERIOR DESIGN IN DUBAI
          </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              <p>
                RadyInterior transformed a glass room in Villa Mirdif into a warm, serene retreat, blending rustic textures with a relaxed bohemian aesthetic. The aim was to create a cozy space filled with natural character, ideal for quiet moments, casual gatherings, or creative work.</p>
              
              <p>
                <b>Design Approach:</b>
                The concept combines bohemian comfort with rustic authenticity, using:<br />
                <ul className="list-disc pl-5 space-y-1 text-white/90 italic">
                  <li>Distressed natural wood</li>
                  <li>Earthy tones and warm colour layers</li>
                  <li>Soft textiles and woven elements</li>
                  <li>Handcrafted decorative accents</li>
                </ul>
                
                This combination creates a laid back environment with timeless charm.
              
                </p>
              
              <div className="space-y-2">
                <p>
                 <b>Use of Natural Light:</b> The existing glass enclosure became the highlight of the design. Natural light enhances the organic textures, ceramics, fabrics, and greenery, giving the room a calming atmosphere throughout the day.
                </p>
              ...
              <p>
                <b>Execution & Styling:</b> Vintage decor, planters, woven baskets, and curated accessories were selected to enrich the room’s character. The layout balances relaxation and practicality, making the space functional enough for reading, social time, or daily work.<br></br><b><a href="https://radyinterior.ae/" className="text-[#f0c95a] hover:underline"> READ MORE </a></b> 
              </p>

              <p>
                <b>Project Outcome:</b> The completed glass room is a peaceful sanctuary comfortable, stylish, and thoughtfully curated. It demonstrates <b><a href="https://radyinterior.ae/" className="text-[#f0c95a] hover:underline"> RadyInterior’s </a></b>   ability to create personalized <b><a href="https://radyinterior.ae/" className="text-[#f0c95a] hover:underline"> residential interiors</a></b> that feel authentic and meaningful.
              </p>
