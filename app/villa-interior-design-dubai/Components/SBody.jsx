...
const SBody = () => {
  ...
  return (
    <section className="bg-[#ffffff] text-black">
      {/* Section 1 */}
      <section className="px-6 sm:px-10 md:px-16 lg:px-28 xl:px-40 py-10 font-sans bg-[#ffffff]">
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="w-full lg:w-1/2 flex flex-col justify-start">
              ...
              <p className="text-sm sm:text-base leading-7 mb-4">
                ...
                >
                  premium villa interior design services in Dubai
                </a>
                ...
                <a
                  ...
                  className="text-[#d4af37] hover:text-[#f0c95a] ml-1"
                >
                  Casa Kraft Interiors & Decoration,
                </a>
      ...
      {/* Section 2 */}
      <section className="py-10 px-6 sm:px-10 md:px-16 lg:px-28 xl:px-40 bg-[#ffffff]">
      ...
      {/* Section 3 */}
      <section className="px-6 py-10 sm:px-10 md:px-16 lg:px-28 xl:px-40 bg-[#f5f5f5]">
        ...
        <div className="bg-[#ffffff] py-16 mt-10">
          <div className="max-w-6xl mx-auto text-center px-4">
            ...
            <p className="font-play text-sm sm:text-base max-w-2xl mx-auto">
              We follow a clear and transparent 3-step process to deliver
              seamless villa interior design services in Dubai.
            </p>
