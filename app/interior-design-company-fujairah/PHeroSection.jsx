...
const FujairahHeroSection = () => {
  return (
    <section className="relative w-full h-screen overflow-hidden">
      {/* Background Image */}
      <Image
        src="/images/fujairah-hero.webp"
        alt="Luxury villa interior design in Fujairah"
        fill
        priority
      ...
      <div className="relative z-20 flex items-center h-full">
        <div className="max-w-6xl px-6 md:px-16 text-white">
          ...
          <h1 className="text-3xl sm:text-5xl md:text-4xl font-conthrax leading-tight">
            Interior Design Company in <br /> Fujairah
          </h1>

          {/* Description */}
          <p className="font-play mt-6 max-w-2xl text-gray-200">
            <b>Rady Interiors</b> is a premium interior design company in Fujairah,
            ...
            tailored to contemporary living in one of the UAE’s most scenic and peaceful emirates.
...
export default FujairahHeroSection;