...
const services = [
  {
    title: "Villa Interior Design in Ras Al Khaimah",
    description:
      "Luxury villa interior design with modern layouts, elegant finishes, and functional family spaces.",
    bgImage: "/images/villa-rak.jpg",
    link: "/villa-interior-design-ras-al-khaimah",
  },
  {
    title: "Modern Arabic Interior Design",
    description:
      "Beautiful Arabic-inspired interiors blended with contemporary luxury design concepts.",
    bgImage: "/images/arabic-rak.jpg",
    link: "/arabic-interior-design-ras-al-khaimah",
  },
  {
    title: "Contemporary Home Interiors",
    description:
      "Stylish and functional home interiors designed for modern villas in Ras Al Khaimah.",
    bgImage: "/images/contemporary-rak.jpg",
    link: "/modern-home-interiors-ras-al-khaimah",
  },
  {
    ...
    bgImage: "/images/fitout-rak.jpg",
    link: "/turnkey-fitout-ras-al-khaimah",
  },
];
...
const rakProjects = [
  {
    ...
    image: "/images/villa-project-rak.jpg",
    link: "/ras-al-khaimah-villa-project",
  },
  {
    title: "Modern Living Room Design",
    category: "Residential Interior",
    image: "/images/living-project-rak.jpg",
    link: "/ras-al-khaimah-living-room",
  },
  {
    title: "Elegant Bedroom Interior",
    category: "Villa Interior Design",
    image: "/images/bedroom-project-rak.jpg",
    link: "/ras-al-khaimah-bedroom",
  },
  {
    title: "Kitchen Fit-Out Design",
    category: "Modern Fit-Out",
    image: "/images/kitchen-project-rak.jpg",
    link: "/ras-al-khaimah-kitchen-fitout",
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-8 lg:px-16">
        ...
        <div className="text-center mb-12">
          <h2 className="text-[#d4af37] text-3xl font-conthrax mb-4">
            INTERIOR DESIGN COMPANY IN RAS AL KHAIMAH
          </h2>
          <p className="text-white font-play max-w-5xl mx-auto text-justify">
            ...
            design company in Ras Al Khaimah, specializing in luxury villa interiors,
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
          <div className="w-full lg:w-1/2">
            <Image
              src="/images/rak-about.jpg"
              alt="Interior Design Ras Al Khaimah"
              width={800}
              height={600}
          ...
          <div className="w-full lg:w-1/2">
            <h3 className="text-[#d4af37] text-2xl font-conthrax mb-4">
              Villa Interior Design in Ras Al Khaimah
            </h3>
            <p className="text-white font-play mb-4">
              We design premium villa interiors in Ras Al Khaimah with a focus on open spaces,
        ...
        <div className="text-center mb-10">
          <h2 className="text-[#d4af37] text-2xl font-conthrax">
            Our Services in Ras Al Khaimah
          </h2>
        </div>
        ...
        <div className="text-center mb-10">
          <h2 className="text-[#d4af37] text-2xl font-conthrax">
            Our Ras Al Khaimah Projects
          </h2>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {rakProjects.map((project, i) => (
        ...
        <div className="text-center mb-16">
          <h2 className="text-[#d4af37] text-2xl font-conthrax mb-4">
            Why Choose Rady Interiors in Ras Al Khaimah
          </h2>
          <p className="text-white font-play max-w-5xl mx-auto text-justify">
            Rady Interiors is a trusted interior design company in Ras Al Khaimah,
        ...
        <div className="text-center bg-black py-16">
          <h2 className="text-[#d4af37] text-3xl font-conthrax mb-4">
            Start Your Interior Design Project in Ras Al Khaimah
          </h2>
          <p className="text-white font-play max-w-4xl mx-auto mb-6">
            Transform your villa in Ras Al Khaimah with Rady Interiors.
