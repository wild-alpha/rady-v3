...
const galleryImages = [
  ...
  },
  {
    ...
    alt: "Restaurant lounge seating Ras Al Khaimah resort interior",
    title: "Ras Al Khaimah Resort Restaurant Interior Image 10",
    description: "Relaxed lounge dining space with custom furniture design"
  },
  {
    src: "/images/ATRD (25).webp",
    alt: "Luxury restaurant interior Ras Al Khaimah resort design",
    title: "Ras Al Khaimah Resort Restaurant Interior Image 11",
    description: "High-end restaurant finishes with refined hospitality detailing"
  },
  {
    src: "/images/ATRD (26).webp",
    alt: "Private dining room Ras Al Khaimah resort restaurant",
    title: "Ras Al Khaimah Resort Restaurant Interior Image 12",
    description: "Exclusive private dining space with elegant interior aesthetics"
  },
  {
    src: "/images/ATRD (27).webp",
    alt: "Luxury resort restaurant lounge Ras Al Khaimah",
    title: "Ras Al Khaimah Resort Restaurant Interior Image 13",
    description: "Modern lounge with calm resort-inspired atmosphere"
  },
  {
    src: "/images/ATRD (28).webp",
    alt: "Fine dining luxury restaurant Ras Al Khaimah resort",
    title: "Ras Al Khaimah Resort Restaurant Interior Image 14",
    description: "Grand dining hall with marble accents and premium hospitality design"
  },
  {
    src: "/images/ATRD (29).webp",
    alt: "Modern resort restaurant Ras Al Khaimah interior design",
    title: "Ras Al Khaimah Resort Restaurant Interior Image 15",
    description: "Signature restaurant interior blending luxury and resort comfort"
  },
];
