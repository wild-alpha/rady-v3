...
const services = [
  {
    title: "Villa Interior Design in Barashi Sharjah",
    description:
      "Luxury villa interior design with modern layouts, elegant finishes, and functional family spaces.",
    bgImage: "/images/villa-barashi.jpg",
    link: "/villa-interior-design-barashi-sharjah",
  },
  {
    title: "Modern Arabic Interior Design",
    description:
      "Beautiful Arabic-inspired interiors blended with contemporary luxury design concepts.",
    bgImage: "/images/arabic-barashi.jpg",
    link: "/arabic-interior-design-barashi",
  },
  {
    title: "Contemporary Home Interiors",
    description:
      "Stylish and functional home interiors designed for modern villas in Barashi.",
    bgImage: "/images/contemporary-barashi.jpg",
    link: "/modern-home-interiors-barashi",
  },
  {
    ...
    bgImage: "/images/fitout-barashi.jpg",
    link: "/turnkey-fitout-barashi-sharjah",
  },
];

const barashiProjects = [
  {
    title: "Luxury Villa Interior Project",
    category: "Villa Interior Design",
    image: "/images/villa-project-barashi.jpg",
    link: "/barashi-villa-project",
  },
  {
    title: "Modern Living Room Design",
    category: "Residential Interior",
    image: "/images/living-project-barashi.jpg",
    link: "/barashi-living-room",
  },
  {
    title: "Elegant Bedroom Interior",
    category: "Villa Interior Design",
    image: "/images/bedroom-project-barashi.jpg",
    link: "/barashi-bedroom",
  },
  {
    title: "Kitchen Fit-Out Design",
    category: "Modern Fit-Out",
    image: "/images/kitchen-project-barashi.jpg",
    link: "/barashi-kitchen-fitout",
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-8 lg:px-16">
        ...
        <div className="text-center mb-12">
          <h2 className="text-[#d4af37] text-3xl font-conthrax mb-4">
            INTERIOR DESIGN COMPANY IN BARASHI SHARJAH
          </h2>
          <p className="text-white font-play max-w-5xl mx-auto text-justify">
            ...
            design company in Barashi Sharjah, specializing in luxury villa interiors,
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
          <div className="w-full lg:w-1/2">
            <Image
              src="/images/barashi-about.jpg"
              alt="Interior Design Barashi Sharjah"
              width={800}
              height={600}
          ...
          <div className="w-full lg:w-1/2">
            <h3 className="text-[#d4af37] text-2xl font-conthrax mb-4">
              Villa Interior Design in Barashi Sharjah
            </h3>
            <p className="text-white font-play mb-4">
              We design premium villa interiors in Barashi with a focus on open spaces,
        ...
        <div className="text-center mb-10">
          <h2 className="text-[#d4af37] text-2xl font-conthrax">
            Our Services in Barashi Sharjah
          </h2>
        </div>
        ...
        <div className="text-center mb-10">
          <h2 className="text-[#d4af37] text-2xl font-conthrax">
            Our Barashi Projects
          </h2>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {barashiProjects.map((project, i) => (
        ...
        <div className="text-center mb-16">
          <h2 className="text-[#d4af37] text-2xl font-conthrax mb-4">
            Why Choose Rady Interiors in Barashi
          </h2>
          <p className="text-white font-play max-w-5xl mx-auto text-justify">
            Rady Interiors is a trusted interior design company in Barashi Sharjah,
        ...
        <div className="text-center bg-black py-16">
          <h2 className="text-[#d4af37] text-3xl font-conthrax mb-4">
            Start Your Interior Design Project in Barashi
          </h2>
          <p className="text-white font-play max-w-4xl mx-auto mb-6">
            Transform your villa in Barashi Sharjah with Rady Interiors.
