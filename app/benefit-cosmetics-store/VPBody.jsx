  ...
  return (
    <section className="bg-black text-white px-6 sm:px-10 md:px-16 lg:px-28 xl:px-40 py-10 sm:py-20 font-sans">
      ...
      <p className="text-xs text-[#f0c95a] uppercase tracking-widest mb-4 font-conthrax">
        HOME &gt; PROJECTS &gt; BENEFIT COSMETICS STORE DUBAI
      </p>
      ...
      <div className="relative pl-4 sm:pl-6 mb-20">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              <p>
                RadyInterior completed the full <b><a href="https://radyinterior.ae/" className="text-[#f0c95a] hover:underline">interior fit out Dubai</a></b> for the Benefit Cosmetics flagship store, designing a retail space that reflects the brand’s playful, pink-driven identity while supporting a smooth customer experience. The goal was to create a vibrant, functional, and instantly recognizable store aligned with Benefit’s global aesthetic.
              </p>
              
              <p>
                <b>Design Approach:</b>
                The concept focused on three essentials:<br />
                Playfulness Bright pink tones, curved forms, and branded décor to express Benefit’s lively personality.<br />
                Functionality Clear customer flow, high-visibility display units, and durable finishes suitable for a high traffic retail environment.<br />
                Lighting Balanced lighting for accurate colour viewing, enhanced product presentation, and comfortable beauty trials.
              </p>
              
              <div className="space-y-2">
                <p>
                 <b>Custom Beauty Stations:</b> A key feature of the project is the set of custom-built beauty stations designed for product testing. Each includes:
                </p>
                <ul className="list-disc pl-5 space-y-1 text-white/90 italic">
                  <li>High-CRI task lighting</li>
                  <li>Comfortable seating</li>
                  <li>Integrated storage</li>
                  <li>Easy clean surfaces</li>
                </ul>
                <p>
                These stations support Benefit’s interactive, customer centric shopping experience.
                </p>
              </div>

              <p>
                <b>Fit-Out & Branding Execution:</b> The store features bespoke shelving, branded wall panels, integrated LED lighting, and a layout that highlights hero products while maintaining smooth circulation. Every detail from joinery to lighting was coordinated to deliver a cohesive <b><a href="https://radyinterior.ae/" className="text-[#f0c95a] hover:underline"> commercial interior design Dubai </a></b> retail environment.
              </p>

              <p>
                <b>Project Outcome:</b> The completed store is fun, energetic, and operationally efficient. It strengthens Benefit’s retail presence in Dubai and demonstrates RadyInterior’s capability to create high quality branded spaces for international clients.
              </p>
