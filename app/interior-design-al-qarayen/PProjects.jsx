...
const services = [
  {
    title: "Villa Interior Design in Al Qarayen Sharjah",
    description:
      "Luxury villa interior design with modern layouts, elegant finishes, and functional family spaces.",
    bgImage: "/images/villa-al-qarayen.jpg",
    link: "/villa-interior-design-al-qarayen-sharjah",
  },
  {
    title: "Modern Arabic Interior Design",
    description:
      "Beautiful Arabic-inspired interiors blended with contemporary luxury design concepts.",
    bgImage: "/images/arabic-al-qarayen.jpg",
    link: "/arabic-interior-design-al-qarayen",
  },
  {
    title: "Contemporary Home Interiors",
    description:
      "Stylish and functional home interiors designed for modern villas in Al Qarayen.",
    bgImage: "/images/contemporary-al-qarayen.jpg",
    link: "/modern-home-interiors-al-qarayen",
  },
  {
    ...
    bgImage: "/images/fitout-al-qarayen.jpg",
    link: "/turnkey-fitout-al-qarayen-sharjah",
  },
];

const alQarayenProjects = [
  {
    title: "Luxury Villa Interior Project",
    category: "Villa Interior Design",
    image: "/images/villa-project-al-qarayen.jpg",
    link: "/al-qarayen-villa-project",
  },
  {
    title: "Modern Living Room Design",
    category: "Residential Interior",
    image: "/images/living-project-al-qarayen.jpg",
    link: "/al-qarayen-living-room",
  },
  {
    title: "Elegant Bedroom Interior",
    category: "Villa Interior Design",
    image: "/images/bedroom-project-al-qarayen.jpg",
    link: "/al-qarayen-bedroom",
  },
  {
    title: "Kitchen Fit-Out Design",
    category: "Modern Fit-Out",
    image: "/images/kitchen-project-al-qarayen.jpg",
    link: "/al-qarayen-kitchen-fitout",
  },
];

const AboutAlQarayen = () => {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-8 lg:px-16">
        ...
        <div className="text-center mb-12">
          <h2 className="text-[#d4af37] text-3xl font-conthrax mb-4">
            INTERIOR DESIGN COMPANY IN AL QARAYEN SHARJAH
          </h2>
          <p className="text-white font-play max-w-5xl mx-auto text-justify">
            ...
            design company in Al Qarayen Sharjah, specializing in luxury villa interiors,
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
          <div className="w-full lg:w-1/2">
            <Image
              src="/images/al-qarayen-about.jpg"
              alt="Interior Design Al Qarayen Sharjah"
              width={800}
              height={600}
          ...
          <div className="w-full lg:w-1/2">
            <h3 className="text-[#d4af37] text-2xl font-conthrax mb-4">
              Villa Interior Design in Al Qarayen Sharjah
            </h3>
            <p className="text-white font-play mb-4">
              We design premium villa interiors in Al Qarayen with a focus on open spaces,
        ...
        <div className="text-center mb-10">
          <h2 className="text-[#d4af37] text-2xl font-conthrax">
            Our Services in Al Qarayen Sharjah
          </h2>
        </div>
        ...
        <div className="text-center mb-10">
          <h2 className="text-[#d4af37] text-2xl font-conthrax">
            Our Al Qarayen Projects
          </h2>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {alQarayenProjects.map((project, i) => (
        ...
        <div className="text-center mb-16">
          <h2 className="text-[#d4af37] text-2xl font-conthrax mb-4">
            Why Choose Rady Interiors in Al Qarayen
          </h2>
          <p className="text-white font-play max-w-5xl mx-auto text-justify">
            Rady Interiors is a trusted interior design company in Al Qarayen Sharjah,
        ...
        <div className="text-center bg-black py-16">
          <h2 className="text-[#d4af37] text-3xl font-conthrax mb-4">
            Start Your Interior Design Project in Al Qarayen
          </h2>
          <p className="text-white font-play max-w-4xl mx-auto mb-6">
            Transform your villa in Al Qarayen Sharjah with Rady Interiors.
