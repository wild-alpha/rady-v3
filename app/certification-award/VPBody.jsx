...
export default function VBody() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 gap-10 text-center sm:grid-cols-2 lg:grid-cols-4">
            {certifications.map((item) => (
              <div key={item} className="flex flex-col items-center">
                ...
                <h2 className="max-w-[280px] text-md sm:text-lg lg:text-xl leading-tight text-center">
                  {item}
                </h2>
              </div>
            ))}
          ...
          <div className="max-w-5xl">
            ...
            <div className="mt-6 space-y-5 text-base leading-8 text-white/85 sm:text-lg">
              <p>
                ...
                is not just about aesthetics, it is about{" "}
                <strong>avoiding costly mistakes, delays, and misalignment.</strong>
              </p>
      ...
      <section className="bg-[#efe2b7] py-14 text-black sm:py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl">
            ...
            <div className="mt-6 space-y-5 text-base leading-8 sm:text-lg">
              ...
              <p>
                ...
                <strong> 3D visualization and VR 360 walkthroughs</strong>,
                allowing you to experience your villa, penthouse, or commercial
                space before execution begins.
              </p>
            </div>
