...
const services = [
  {
    title: "Villa Interior Design in Umm Al Quwain",
    description:
      "Luxury villa interior design with modern layouts, elegant finishes, and functional family spaces.",
    bgImage: "/images/villa-uaq.jpg",
    link: "/villa-interior-design-umm-al-quwain",
  },
  {
    title: "Modern Arabic Interior Design",
    description:
      "Beautiful Arabic-inspired interiors blended with contemporary luxury design concepts.",
    bgImage: "/images/arabic-uaq.jpg",
    link: "/arabic-interior-design-umm-al-quwain",
  },
  {
    title: "Contemporary Home Interiors",
    description:
      "Stylish and functional home interiors designed for modern villas in Umm Al Quwain.",
    bgImage: "/images/contemporary-uaq.jpg",
    link: "/modern-home-interiors-umm-al-quwain",
  },
  {
    ...
    bgImage: "/images/fitout-uaq.jpg",
    link: "/turnkey-fitout-umm-al-quwain",
  },
];
...
const uaqProjects = [
  {
    ...
    image: "/images/villa-project-uaq.jpg",
    link: "/umm-al-quwain-villa-project",
  },
  {
    title: "Modern Living Room Design",
    category: "Residential Interior",
    image: "/images/living-project-uaq.jpg",
    link: "/umm-al-quwain-living-room",
  },
  {
    title: "Elegant Bedroom Interior",
    category: "Villa Interior Design",
    image: "/images/bedroom-project-uaq.jpg",
    link: "/umm-al-quwain-bedroom",
  },
  {
    title: "Kitchen Fit-Out Design",
    category: "Modern Fit-Out",
    image: "/images/kitchen-project-uaq.jpg",
    link: "/umm-al-quwain-kitchen-fitout",
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-8 lg:px-16">
        ...
        <div className="text-center mb-12">
          <h2 className="text-[#d4af37] text-3xl font-conthrax mb-4">
            INTERIOR DESIGN COMPANY IN UMM AL QUWAIN
          </h2>
          <p className="text-white font-play max-w-5xl mx-auto text-justify">
            ...
            design company in Umm Al Quwain, specializing in luxury villa interiors,
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
          <div className="w-full lg:w-1/2">
            <Image
              src="/images/uaq-about.jpg"
              alt="Interior Design Umm Al Quwain"
              width={800}
              height={600}
          ...
          <div className="w-full lg:w-1/2">
            <h3 className="text-[#d4af37] text-2xl font-conthrax mb-4">
              Villa Interior Design in Umm Al Quwain
            </h3>
            <p className="text-white font-play mb-4">
              We design premium villa interiors in Umm Al Quwain with a focus on open spaces,
        ...
        <div className="text-center mb-10">
          <h2 className="text-[#d4af37] text-2xl font-conthrax">
            Our Umm Al Quwain Projects
          </h2>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {uaqProjects.map((project, i) => (
        ...
        <div className="text-center mb-16">
          <h2 className="text-[#d4af37] text-2xl font-conthrax mb-4">
            Why Choose Rady Interiors in Umm Al Quwain
          </h2>
          <p className="text-white font-play max-w-5xl mx-auto text-justify">
            Rady Interiors is a trusted interior design company in Umm Al Quwain,
        ...
        <div className="text-center bg-black py-16">
          <h2 className="text-[#d4af37] text-3xl font-conthrax mb-4">
            Start Your Interior Design Project in Umm Al Quwain
          </h2>
          <p className="text-white font-play max-w-4xl mx-auto mb-6">
            Transform your villa in Umm Al Quwain with Rady Interiors.
