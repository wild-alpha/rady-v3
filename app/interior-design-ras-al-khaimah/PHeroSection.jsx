...
const RasAlKhaimahHeroSection = () => {
  return (
    <section className="relative w-full h-screen overflow-hidden">
      {/* Background Image */}
      <Image
        src="/images/ras-al-khaimah-hero.webp"
        alt="Luxury villa interior design in Ras Al Khaimah"
        fill
        priority
      ...
      <div className="relative z-20 flex items-center h-full">
        <div className="max-w-6xl px-6 md:px-16 text-white">
          ...
          <h1 className="text-3xl sm:text-5xl md:text-4xl font-conthrax leading-tight">
            Interior Design Company in <br /> Ras Al Khaimah
          </h1>

          {/* Description */}
          <p className="font-play mt-6 max-w-2xl text-gray-200">
            <b>Rady Interiors</b> is a premium interior design company in Ras Al Khaimah,
            ...
            tailored to contemporary living in one of the UAE’s most scenic and rapidly developing emirates.
...
export default RasAlKhaimahHeroSection;